...
FIXED_AFF_POSTS = [
    {
        'name': '折りたたみ日傘（UVO CALM）',
        'body': "旅先の日焼け、毎年後悔してたのがこれで解決した\n完全遮光100%・UVカット100%で晴雨兼用のコンパクト日傘\n夏前に1本あると全然ちがう",
        'url': 'https://a.r10.to/h5Mbza',
    },
    {
        'name': 'キッズルームウェア',
        'body': "旅行のパッキングで毎回悩む子どものパジャマ問題\nかわいいルームウェアなら旅先でも使えて荷物にならない\n1,380円〜で揃えられるのが助かる",
        'url': 'https://a.r10.to/h5mUrT',
    },
    {
        'name': 'チョーカー（shiori×AJIROコラボ）',
        'body': "旅行コーデのアクセサリー、いつも悩んでたのがこれで固定になった\n金属アレルギー対応で付けっぱなしでも錆びない、旅先に最高のチョーカー\n2,420円でこのクオリティ",
        'url': 'https://a.r10.to/h5m3qj',
    },
    {
        'name': '持続冷感ブラトップ（バンビウォーター）',
        'body': "今年の夏、下着まで蒸れるのがマジで無理だった\n接触冷感でカップ付き、ノンワイヤーで締め付けない神ブラキャミ見つけた\n3,790円でこの快適さ",
        'url': 'https://a.r10.to/hP1PSZ',
    },
    {
        'name': 'UVO公式 日傘（完全遮光・2段Wpc）',
        'body': "日傘のコンパクトさと遮光、両方は無理だと思ってた\n完全遮光100%・UVカット100%なのに2段折りで晴雨兼用、荷物にならない\n8,250円",
        'url': 'https://a.r10.to/hYe6Zb',
    },
    {
        'name': '黒モリモリスリム（プーアル茶風味）',
        'body': "夏の旅行前、地味に焦って始めたのがコレ\nプーアル茶風味で美味しく続けられるダイエット茶\n30日分4,800円〜",
        'url': 'https://a.r10.to/hYhCxc',
    },
    {
        'name': 'ロッソカフェ ネスプレッソ互換カプセル',
        'body': "在宅ワークのコーヒー代、地味にバカにならないから互換カプセルに変えた\nネスプレッソ対応で6種×20カプセル、120杯分\n送料無料で6,500円",
        'url': 'https://a.r10.to/h5qHni',
    },
    {
        'name': "d'Alba ミストソリューション美容液",
        'body': "旅行前バタバタしてても肌だけは諦めたくなくて\nミストするだけの導入美容液、保湿・鎮静・ツヤが一気に叶う韓国コスメ\n4,800円でキット届くのが嬉しい",
        'url': 'https://item.rakuten.co.jp/dalba/kancos04_ad/',
    },
    {
        'name': 'うまれて！ウーモ ヨッシー（スーパーマリオ）',
        'body': "子どもがずっと「ヨッシーの卵がほしい」って言ってて\nたまごを開けるとちゃんと生まれてくる仕掛けが可愛すぎた\n10,285円、誕生日プレゼントにも良さそう",
        'url': 'https://a.r10.to/hka5kr',
    },
]
