...
TWEET_STOCK = [
    ...
    "子どもの期末テスト前日。プリントの写真を送るだけで、タブレット対応のフラッシュカード＋4択クイズが完成した。塾代7万円/月払いながら「テスト前の使い方」はAIで補えた。AIは副業だけじゃなく子育てにも使える。 #ワーママ #ClaudeCode #子育て",
    "中1の息子の期末テスト対策をClaudeに頼んだ。授業プリントを読み込ませたら、世界の気候・宗教・地形図の問題をセクション別に整理して、クイズ形式で出題してくれた。私がやったこと：写真を撮って渡しただけ。 #ClaudeCode #子育て #ワーママ",
    # ── 2026-07-02追加 ──
