...
TWEET_STOCK = [
    ...
    "子供の予定はずっと自分でGoogleカレンダーに入力してた。それでも3人分の重複には気づけなかった。Claude Codeに読み込ませたら「ここ重なってます」と即指摘された。入力できることと重複に気づけることは別スキルだと痛感した。 #AI副業 #ワーママ #Claude",
    # ── 自動化全体・積み上げ系 ──
    ...
    # ── 2026-07-09追加 ──
    "長い作業をお願いしても、Claude Codeが途中で止まらなくなった。6月は「いつ止まるか分からない」が不安で使うのを諦めた日もあった。今はコンテキストが増えると自動で要約して続きから作業してくれる仕組みに進化してた。不安だった弱点が知らない間に直ってるの、AIツールならでは。 #AI副業 #ClaudeCode #個人開発",
    # ── 2026-07-12追加 ──
    "楽天マラソンでポイント狙いで仕入れた商品、実は利益がほとんど出ていなかった。ポイント還元に気を取られて、Amazon側の利益確認を後回しにしてたのが原因。今はJANコードを送るだけでAIが仕入れ前にサッと利益を計算してくれる。ポイントと仕入れ判断は分けて考えるようにした。 #AI副業 #物販 #Amazon物販",
    "仕入れ候補をAIに一括チェックしてもらったら、思ってたより利益が出ない商品がいくつか見つかった。1個の原価と6個入りBOXのAmazon価格を比べていたのが原因。JANコードさえ分かれば、AIが仕入れ前に利益をきちんと計算してくれるので助かってる。 #AI副業 #Amazon物販 #ClaudeCode",
]
