...
# 30店舗を6グループ(5,5,5,5,5,5)に分割。各グループに Yahoo1店 + 楽天2〜3店 + Shopify製メーカー直販1店 を配置し、
# 5・10のつく日6回で全30店舗をちょうど1巡する。(name, site, url)
STORE_GROUPS = {
    5: [
    ...
    20: [
        ...
        ("plywood 楽天市場店", "rakuten", "https://www.rakuten.co.jp/plywood/"),
