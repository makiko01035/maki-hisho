...
from sourcing_calendar import run_sourcing_scan, run_watchlist_check
...
# 5・10のつく日 朝4:45：定番商品ウォッチ（「電脳仕入れ候補」シートでチェック済みの行だけAmazon価格を再チェック）
scheduler.add_job(run_watchlist_check, 'cron', day='5,10,15,20,25,30', hour=4, minute=45)
