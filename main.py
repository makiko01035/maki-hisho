...
QUOTE_TWEET_TEMPLATES = [
    ...
    # ── A8アフィ×ブログ即投稿（2026-05-18追加） ──
    "A8でアフィバナー取れた→その日のうちに記事を書いてWordPressに公開した✅ 「車中泊で眠れない原因」の記事にマット広告を自然に入れる構成にして、バナーリンクも自動挿入。ネタを見つけたらAIに渡すだけで記事になる仕組みが整ってる。 #AI副業 #ブログ #アフィリエイト",
]
