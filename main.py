...
TWEET_STOCK = [
    "習い事チラシの手入力をゼロにした🙌 以前は写真を見ながら日時・場所を一つずつ打ち込んでた。今はLINEにチラシ写真を送るだけ。AIが日時を読み取ってGoogleカレンダーに自動登録してくれる。ワーママの地味なストレスが丸ごと消えた。 #AI副業 #ワーママ #LINE",
    "申込期限の締切忘れがゼロになった✨ 前は「あ、明日締切だった…」と慌てて申し込むのが何度もあった。今はLINEに「〇〇の期限 5月10日」と送るだけ。1週間前・3日前・前日・当日に自動でリマインドが届く。仕組みが記憶を代わりにやってくれてる。 #AI副業 #自動化 #LINE",
    "カレンダー登録が1件しか対応してなかった問題を直した😄 チラシに3つイベントが書いてあっても最初の1件だけ登録されてて「あれ？」ってなってた。複数イベントを全部抽出して全部登録するように改良。こういう小さい改善ほど毎日使うたびに効いてくる。 #AI副業 #LINE #自動化",
    "「登録したのに消えた」が二度と起きなくなった🔧 Renderのサーバーが再起動すると登録待ちのデータが消えてしまう問題があった。状態をメモリじゃなくファイルに保存する方式に変えて解決。本番運用って、こういう見えないところの作り込みが全部。 #AI副業 #個人開発 #Claude",
    "毎朝7時にLINEで今日・明日の予定が届く🌅 自分で作ったリマインダー。今日だけじゃなく明日の予定も一緒に確認できる。朝の支度しながら「今日何がある、明日は何を準備」が一目でわかる。地味だけど毎日一番助かってる機能になった。 #AI副業 #LINE #自動化",
    "気づいたら20個以上の自動化が同時に動いてた😳 医療職×育児で作業時間は1日1〜2時間。それでも毎日少しずつ積み上げたら1ヶ月弱でここまで来た。チラシ読み取り・カレンダー管理・ブログ自動投稿・eBayリサーチ…全部の記録をnoteにまとめた→ https://note.com/maki_claude_lab/n/n0bf26963cd26 #AI副業 #医療職 #ClaudeCode",
    "ブログ記事の公開が「書いて」の一言で完結するようになった✍️ テーマを決める→記事を書く→アイキャッチ画像を選ぶ→WordPressに公開、の全工程を自動化した。LINEから指示するだけで10分後に記事が公開されてる。ブログ更新の心理的ハードルが消えた。 #AI副業 #ブログ自動化 #Claude",
    "薬膳ブログのリライトを完全自動化した🌿 「どの記事をリライトするか選ぶ」のすら面倒だったので、季節に合った記事をAIが自動で選んでくれるようにした。選んだ記事をリライトして公開まで全自動。LINEで「リライト」と送るだけで終わる。 #AI副業 #ブログ #自動化",
    "出先からでもeBayリサーチができるようになった📱 以前は帰宅してからPCで検索する必要があった。今はLINEに商品名を送るだけでリサーチが始まる。通勤中・待ち時間に仕入れ候補を調べられる。家のPCに縛られなくなった。 #AI副業 #eBay #物販",
    "Pinterest APIの解禁を待ちながら、解禁直後に動ける準備を整えた🔧 Trial accessが審査で拒否されてまだ使えない状態。でも待ってる間にOAuth認証の実装は全部完了させた。解禁されたその日から自動投稿が始まる。止まらないのが大事。 #AI副業 #自動化 #Claude",
    "X投稿のネタを毎日考えなくていい状態を作った😌 「今日何投稿しよう」って悩む時間がゼロになった。実体験を溜めてストック化→日付ベースで自動選択→朝・昼・夜に自動投稿。副業のSNS運用が完全に「仕組み」になった。 #AI副業 #X #自動化",
    "学校のプリント紛失がゼロになった📄 「あのプリントどこに置いた？」が毎回プチストレスだった。LINEに写真を送るだけで内容をAIが読み取って保管してくれる仕組みを作った。プリント管理は「仕組みに任せる」でいい。 #AI副業 #ワーママ #LINE",
    "プログラミングゼロからLINE秘書ボットを作るまでの全工程をnoteにまとめた📝 何から始めたか・どうClaudeに頼んだか・失敗してどう直したか、全部書いた。「自分もできるかも」と思ってもらえたら嬉しい。1,480円→ https://note.com/maki_claude_lab/n/n0bf26963cd26 #AI副業 #note #Claude",
    "忘れっぽい自分には「仕組みで強制する」設計が合ってる。A8.netの審査確認を毎週月曜にLINEへ自動通知するようにした。通知が来るまで忘れっぱなしだったのが、毎週かならず確認できるようになった。人間が覚えるより仕組みが覚える方が確実。 #AI副業 #アフィリエイト #自動化",
    "習慣化を「意志力」に頼るのをやめた。月初の振り返りを毎月1日にLINEに自動で届くようにしたら、忘れず振り返れるようになった。「やろうと思ってたけど忘れた」がなくなる。続けるために必要なのは気合いじゃなくて、仕組み。 #AI副業 #習慣化 #自動化",
    "月0円で24時間稼働するサーバーを運用できてる。Renderのフリープランはアクセスがないとスリープするのでpingエンドポイントを追加した。これだけで無料プランでも本番運用できる状態になった。お金をかけなくても動かせるのが個人開発の強み。 #AI副業 #個人開発 #Render",
    "Claudeと一緒にデバッグするのが得意になってきた🔍 以前はエラーが出ると手が止まってた。今はエラーログをそのまま貼るだけで「これが原因で、こう直す」と返ってくる。タイムアウトエラーもバックグラウンド処理に変えてあっさり解決。デバッグが怖いスキルじゃなくなった。 #AI副業 #個人開発 #Claude",
    "22時開始のイベントが翌0時終了のとき、終了日時が翌日にならないバグを直した🗓️ 誰も気づかないような細かい仕様だけど、自分が毎日使うツールだから「なんか変な登録になった」ってなる。見えないところのクオリティにこだわるほど、使うたびに気持ちいい。 #AI副業 #個人開発 #自動化",
    "プログラミングゼロでもClaude Codeがあれば本当に作れる😊 コードは一行も書けないけど「どうなってほしいか」を言葉で伝えることならできる。それだけで動くものが出来上がる。「技術がないから無理」は思い込みだったと知った。全記録→ https://note.com/maki_claude_lab/n/n0bf26963cd26 #AI副業 #ClaudeCode #初心者",
    "RenderとGitHubを組み合わせたら月0円でデプロイまで全自動になった。コードを書いてpushするだけで2〜3分後にサーバーに反映される。お金をかけなくても本番運用できる時代になった。個人開発のハードルが下がりまくってる。 #AI副業 #個人開発 #Render",
    "医療職×育児で自由な時間が限られてる分、「これ自動化すべきか」の判断が早くなった。毎日繰り返す作業・忘れやすいこと・ミスが起きやすいことは全部自動化する。時間がないからこそ、仕組みに投資する発想になれた。作って損したことが一度もない。 #AI副業 #医療職 #副業",
    "アフィリエイトリンクの貼り忘れがゼロになった✨ 薬膳記事を書くたびに末尾にCTAを手動で貼ってたけど、たまに忘れて収益機会を逃してた。記事公開時に自動挿入する機能を追加したら完璧に解決。地味だけど確実に収益が変わる改善だった。 #AI副業 #ブログ #アフィリエイト",
    "自分のAI会社の状況がLINEで「会社」と打つだけで全部見られる👀 売上・ブログ記事数・eBay出品数が一画面に。移動中でも今の状況を瞬時に把握できる。自分の事業を「見える化」したら、何を優先すべきかが自然とわかるようになった。 #AI副業 #ClaudeCode #自動化",
    "「なんか登録されなかった」が起きなくなった。チラシ写真から複数イベントを抽出するJSONパースが不安定で、たまに1件だけ取れて残りが消える問題があった。パース処理を作り直して安定化。見えないバグほど原因特定に時間がかかって、解決したときの達成感もでかい。 #AI副業 #個人開発 #Claude",
    "コードを整理したら次の機能追加が明らかにスムーズになった。main.pyが1ファイルで全機能を管理していたので、機能ごとにモジュール分割してリファクタリングした。「読みやすいコード＝開発速度が上がる」を体感した。整理は未来への投資。 #AI副業 #個人開発 #ClaudeCode",
    "LINEボット1本にできることを全部詰め込んだ結果、副業がほぼスマホだけで完結するようになった📱 ブログ投稿・カレンダー管理・eBayリサーチ・プリント管理・X自動投稿…全部LINEから。専用アプリを使い分ける必要がなくなった。 #AI副業 #LINE #自動化",
    "AIに「秘書部が司令塔」という役割を与えたら、何でも頼めるようになった😮 以前は「これはどのツールで処理する？」と毎回迷ってた。秘書部に話しかけるだけで自動的に適切な処理が走る仕組みにしたら、迷いがゼロになった。役割設計って大事。 #AI副業 #ClaudeCode #自動化",
    "子どもが寝た後の1〜2時間でここまで作れるようになった。コードが書けなくても「作りたいものが明確」なら進める。毎日少しずつ積み上げたら1ヶ月でLINEボット・ブログ自動化・eBay管理ツールが全部揃った。全工程まとめた→ https://note.com/maki_claude_lab/n/n0bf26963cd26 #AI副業 #ワーママ #副業",
    "自動化の恩恵、記事が増えるほど大きくなってきた📈 薬膳120記事・セキスイ34記事。手動で管理してたら更新するたびに手間が増える。自動化してあると記事が増えるほど「何もしなくていい分」が増える。仕組みを作る労力は一回、恩恵は永続する。 #AI副業 #ブログ #アフィリエイト",
    "最初は一番むずかしかったGoogle CalendarのOAuth認証、今では当たり前に使えてる🔑 「OAuth？認証フロー？意味不明」だったのが、LINEボットに組み込んで毎日使ううちに完全に理解した。難しいことも使い続けると慣れる。慣れるまで逃げないのが大事。 #AI副業 #個人開発 #Google",
    "デバッグが怖くなくなった💪 以前はエラーが出た瞬間「詰んだ」と思ってた。今はエラーログをClaudeに貼るだけで大体解決する。「エラー→貼る→直る」の体験を何十回も繰り返したら、エラーが来ても「どうせ直せる」と思えるようになった。全記録→ https://note.com/maki_claude_lab/n/n0bf26963cd26 #AI副業 #ClaudeCode #初心者",
    "メルカリで仕入れてeBayで売る物販を始めてる。仕入れ→出品の流れをいずれ自動化したい。まず手動でフローを覚えて、繰り返しが生まれたら自動化する順番でやってる。自動化は「何を自動化するか」がわかってからじゃないと設計できない。 #AI副業 #eBay #物販",
    "毎月忘れてたFammの締切がゼロになった。毎月6日が更新締切なのに「あ、また過ぎてた」が続いてた。3日前と当日にLINEリマインダーを追加したら完璧に対応できるようになった。忘れるのは意識の問題じゃなくて仕組みの問題。 #AI副業 #ワーママ #自動化",
    "エラーメッセージを改善したら使い心地が明らかに変わった。「登録して」を送ってもカレンダーデータがないとき、前は無言で失敗してた。「まず画像を送ってください」という案内を返すように直した。自分が毎日使うツールだから、細部の体験にこだわる価値がある。 #AI副業 #個人開発 #LINE",
    "ChatGPTじゃなくてClaude Codeを使ってる理由は、ファイルを直接読み書きできて、コードを実行しながら作れるから。会話してる間に実際のファイルが変わっていく。「AIに相談した→自分でコードに反映」という手間がない。この差は体験してみないとわからない。 #AI副業 #ClaudeCode #Claude",
    "毎日少しずつ積み上げたら1ヶ月弱でGitコミット数が50を超えた。「今日は30分しかない」という日でも小さく前進した。途中で止まらなかっただけで、これだけ変わる。続けることの価値は、続けた人にしかわからない。 #AI副業 #ClaudeCode #副業",
    "LINE秘書ボットを作って一番変わったこと：「今日何の予定あったっけ」がゼロになった。毎朝7時に今日・明日の予定が届くので、確認しに行く必要すらない。予定を忘れてた自分が、今は「忘れない仕組み」の中で生活してる。 #AI副業 #LINE #ワーママ",
    "ブログのアイキャッチ画像選びが完全に自動になった🖼️ 以前は記事を書くたびに画像を探して・選んで・設定する時間がかかってた。Pexels APIと連携させて、記事テーマに合った画像を自動で取得・設定するようにした。記事を書いたら全部終わってる状態になった。 #AI副業 #ブログ自動化 #Claude",
    "最初は意味不明だった「環境変数」、今は10個以上を全部把握して管理できてる。「.envに何を書くか」すら理解できなかった自分が、Renderの管理画面でAPIキーを追加・更新できる。理解は突然やってくる。わからなくてもやり続けると、ある日わかる。 #AI副業 #個人開発 #Render",
    "副業の週次スケジュールを全部自動通知にした。月曜A8審査確認・火曜薬膳ブログ・木曜セキスイブログ・土曜eBayチェック。各曜日の朝にLINEで通知が届く。「今週何するんだっけ」と考えなくていい。週の行動が仕組みで決まると、迷いなく動ける。 #AI副業 #副業 #習慣化",
    # ── まるちゃんワールド（ゲーム系） ──
    "息子と一緒に遊べるタイピングゲームをClaude Codeで作った🎮 「一緒に遊べるゲームがほしい」と思っただけでスタート。コードはゼロ行も書いてない。Claudeに「こんなゲームを作りたい」と伝えたら本当に出来上がった。プログラミング経験ゼロでゲームが作れる時代になった。 #AI副業 #ClaudeCode #ゲーム開発",
    "プログラミングゼロでゲームシリーズを作り始めた。タイピング・アクションと2作品をHTMLファイル1枚ずつ作った。コードは全部Claudeが書いてくれた。「まるちゃんワールド」という名前でシリーズ化した。医療職ワーママがゲームシリーズを持つ日が来るとは思ってなかった。 #AI副業 #ClaudeCode",
    "AIで作ったゲームをGitHub Pagesで無料公開できた📡 サーバー代ゼロ・ドメイン代ゼロ。URLをLINEや家族に送ればどこからでも遊べる。「公開」のハードルがこんなに低くなったことに驚く。作ったものを世界に出せる、それだけでモチベーションが続く。 #AI副業 #個人開発 #ClaudeCode",
    "子どもの練習用に作ったタイピングゲームに自分がハマった😂 かんたん・ふつう・むずかしい・1文字モードの4段階。BGMも効果音もAIが作ってくれた。「作ること」が目的だったのに「遊ぶこと」が楽しくなった。こういう副産物があるのが個人開発の醍醐味。 #AI副業 #ワーママ",
    "まるちゃんワールドに音ゲーを追加した🎵 F・G・H・Jキーでノーツをたたく3ステージ。むずかしいモードは本当に難しい。Claudeに「もっと難しくして」って言ったら本当に難しくなった笑。コードをゼロ行も書かずに音ゲーが作れる、この時代のすごさを感じてる。 #AI副業 #ClaudeCode #ゲーム開発",
    "AIで「ゲーム部」を正式に立ち上げた🎮 タイピング・アクション・音ゲーと3作品ができたので部署化した。プログラミングゼロの医療職ワーママが、AI会社の組織図にゲーム部を追加する日が来るとは。Claudeと一緒に作ると「できること」の定義が変わる。 #AI副業",
    "まるちゃんワールドの音ゲー、むずかしいモードはノーツが速すぎる😂 90秒間ずっと集中してないといけない。Claudeに「もっと速くして」って言うたびに本当に速くなった。「作る側」にいるのに「難しすぎてクリアできない」という本末転倒な状況になってる。 #ClaudeCode #ゲーム開発",
    # ── eBay API連携 ──
    "自分の出品120品がリストで一覧できるようになった📦 以前はeBayのマイページをスクロールしながら確認してた。APIをClaude Codeで連携させたら、LINEから全出品を一覧で見られるように。プログラミングゼロでもAPIって繋げるんだと初めて実感した。 #AI副業 #eBay #物販",
    "eBayのマイページを手動で確認しなくていい状態を作った🙌 売上・ウォッチャー数・出品総額を毎回手動で確認してた。APIで自動取得するようにしたら、LINEで一瞬でわかるようになった。同じ作業を何度もやってると気づいたら、それは自動化のサイン。 #AI副業 #eBay #自動化",
    "eBayの月間$7,000出品上限の存在を知らなかった😳 出品しようとしたら弾かれて初めて気づいた。Seller Hubの説明が英語で意味不明だったのをClaudeが一緒に解読してくれた。知らないルールでつまずく→AIが一緒に解決する、この体験が積み重なって強くなる。 #AI副業 #eBay #物販",
    "英語が苦手でもeBayで全然問題ない。サポートチャットへの問い合わせ文、全部Claudeに作ってもらった。「こういう問題が起きてます、こう解決してほしい」と日本語で伝えるだけで、適切な英文を作ってくれる。英語の壁はAIで完全に消えた。 #AI副業 #eBay #物販",
    "eBayの出品タイトルを51件APIで一括変更した✨ 「Kumano Fude」「Japan Unused New」などの検索キーワードを全タイトルに追加。手作業なら半日かかる量が数分で完了した。一度仕組みを作れば次回も同じコスト。タイトルのCTR改善が加速した。 #AI副業 #eBay #自動化",
    "eBay Trading APIで出品中のタイトルをコードで一括変更できると知った📝 CTR改善のためにキーワードを全商品に追加したかった。手動なら一品ずつ編集→何時間もかかる。APIで全品一括処理→数分で完了。プログラミングゼロでも仕組みを作れば、毎回ラクになる。 #AI副業 #eBay #物販",
    "ブログ記事を公開したら自動でInstagramに投稿される仕組みを作った📸 Zapier＋WP Webhooksの組み合わせで完全無料。しかも画像にタイトル文字を自動合成してる。記事を書いたらInstagramの投稿まで全部終わる。やることリストから「インスタ投稿」が消えた。 #AI副業 #自動化 #ブログ",
    "Zapierって無料でもかなりのことができる。WordPressの新記事公開→Instagramへの自動投稿、設定30分でできた🙌 コードを書かずにツールをつなぐだけ。プログラミングゼロでも連携できる。「何ができるか」より「何をつなぐか」の発想が大事。 #AI副業 #Zapier #自動化",
    "ブログのアイキャッチ画像にタイトルが自動合成されるようになった🖼️ Instagram用に1:1リサイズ→タイトルをオーバーレイ→保存まで全部Pythonで自動処理。以前は手作業でやってた。自動化できると「こんな細かいこともできるのか」と毎回驚く。 #AI副業 #Python #自動化",
    # ── 音声文字起こし ──
    "ZOOMの録画をAIで自動文字起こし＋議事録にする仕組みを作った🎤 Groqという無料APIを使えばコスト0円。350MBのMP4でも自動で分割して全部処理してくれる。「会議の録音、どうせ聞き返さない」が解消された。AIが議事録を作ってくれる時代になった。 #AI副業 #自動化 #ClaudeCode",
    "LINEに音声メッセージを送ると自動で文字起こしして返ってくる仕組みを作った✨ 短い録音はLINE・長い会議録音はPCツール、と使い分けられるようになった。「話す→テキストになる」だけで使い方が広がる。メモ代わりに音声を送る習慣ができた。 #AI副業 #LINE #自動化",
    "会議の録音、もう自分で聞き返さなくていい状態になった😌 ダブルクリックでアプリ起動→ファイル選択→待つだけ。Groq Whisperが無料で文字起こし→AIが要約→議事録がデスクトップに保存される。何時間の録音でも「待つだけ」になった。 #AI副業 #自動化 #時短",
    "途中でネットが切れて13/18チャンクで処理が止まって絶望した😇 でもClaudeにその場で「前回の続きから再開する機能」を追加してもらって、次の起動で14チャンク目から自動スタートできた。ゼロからやり直しにならなかった。トラブルがあっても「そこから続けられる仕組み」があれば怖くない。 #AI副業 #ClaudeCode #自動化",
    "3時間の会議録音（176分）が全自動で議事録になった🎤 18分割→文字起こし→チャプターごと要約→デスクトップに保存。コスト0円、やることはファイルを選んで待つだけ。「長い会議ほどAIに任せた方がいい」と確信した。 #AI副業 #自動化 #時短",
    "Instagramにビルの写真が自動投稿されてて「いまいち」と気づいた😂 日本語タイトルをそのままPexels検索に使ってたのが原因。Claudeに「住宅系の英語キーワードに変換」してもらうよう変えたら、ちゃんとした住宅写真が選ばれるようになった。自動化は作って終わりじゃなく改善の繰り返し。 #AI副業 #自動化 #ClaudeCode",
    # ── 薬膳Instagram・SNS自動化 ──
    "薬膳ブログのアイキャッチ画像を全自動にした🌿 以前は自分で「食材の並び写真」を選んでた。今は日本語タイトルをAIが英語キーワードに変換→Pexelsで完成料理写真を取得→WPに自動設定。「食べたい！」と思う写真になって、CTRも変わってきた。 #AI副業 #ブログ自動化 #薬膳",
    "薬膳記事を公開したらInstagram用スライドが自動生成される📸 1枚目:料理写真 2枚目:食材リスト 3枚目:効能まとめ。あとはInstagramに投稿するだけ。記事を書くたびにInstagram素材が揃う状態になった。1つの作業から複数の成果物が出るのが自動化の醍醐味。 #AI副業 #Instagram #自動化",
    "薬膳レシピのInstagramアカウント（@foodmakehealth）を開設した🌿 「医療職ワーママが実践する薬膳」というコンセプトで。医療職という肩書きを前面に出したら、コンセプトが一気に明確になった。「何を発信するか」より「誰が発信するか」の方が大事だと実感。 #AI副業 #薬膳 #Instagram",
    "AmazonアフィリエイトのCTAの貼り忘れがゼロになった📚 薬膳記事の内容に応じて自動判定→挿入する仕組みを作った。子ども向け記事なら「こども薬膳」、スープ系なら「スープジャー弁当」と内容に合ったリンクを選んでくれる。収益機会を逃すのは仕組みの問題だった。 #AI副業 #アフィリエイト #自動化",
    "特定の薬膳記事だけ選んでリライトできるようになった🔄 「全記事の中から1本だけリライトしたい」というニーズに対応。記事URLをLINEに貼るだけで、その記事を選択してリライト・公開まで完結する。細かい要望に答えるほど、自分にとって使いやすくなる。 #AI副業 #ブログ自動化 #LINE",
    "薬膳記事のテーマ選定を完全自動化した🌱 4月なら「花粉症・PMS・春の倦怠感」、7月なら「夏バテ・熱中症」と季節×症状で自動決定。子ども向けも月数回自動で混ぜる。「何を書くか決める」という一番めんどくさい工程をAIに任せたら、執筆開始まで一秒もかからなくなった。 #AI副業 #薬膳 #自動化",
    "薬膳ブログのカルーセル画像、2枚目・3枚目がずっと届かなかった原因がフォントファイルのバイナリ破損だった😅 .gitattributesにlfs設定を追加して解決。原因が特定できるまで3時間かかった。地味なバグほど原因特定に時間がかかって、解決したときの安堵感がでかい。 #AI副業 #個人開発 #ClaudeCode",
    "薬膳記事のテーマ選定、最初はPMSばかり選ばれてた😂 18カテゴリあるのに1つに偏る問題。直近15記事と照合して未使用カテゴリを選ぶ仕組みにしたら均等になった。AIは「シンプルに任せる」と偏るので、ちゃんとロジックを設計する必要がある。この試行錯誤が楽しい。 #AI副業 #ブログ自動化 #薬膳",
    # ── eBayリサーチAI進化 ──
    "eBayリサーチがスマホのLINEだけで完結するようになった📦 「ebay 風呂敷」と送るだけで10個のキーワードを並列検索→結果が届く。出先や通勤中に仕入れ候補を調べられる。家のPCの前に座らないとできなかったリサーチが、いつでもどこでもできるようになった。 #AI副業 #eBay #物販",
    "穴場商品を見つける精度が上がった👀 eBayリサーチに「ウォッチャー数」を追加した。競合が少なくて・価格が高くて・ウォッチャーが多い商品＝需要はあるのに出品者が少ない穴場。この判定ロジックをリサーチ結果に自動で適用するようにした。勘より数字で判断できるようになった。 #AI副業 #eBay #物販",
    "AIが出した候補は最終的に自分の目で確認する💡 eBayリサーチの結果に「次のステップ」を追加した。検索結果が出たら→Sold Listingsで絞る→30日の売れ数確認の3ステップをガイドとして表示。AIを信頼しながらも、最後の判断は自分でする。この一手間が仕入れ精度を上げる。 #AI副業 #eBay #物販",
    "eBayリサーチを並列検索に変えたら体感速度が全然違う⚡ 以前は1キーワードずつ順番に検索→全部終わるまで待つ方式だった。全キーワードを同時に検索する方式に変えたら、同じ結果が数分の1の時間で届くようになった。「待ち時間を減らす」のも立派な自動化。 #AI副業 #eBay #ClaudeCode",
    # ── Webマーケティング・Sheets API ──
    "競合分析のコピペ作業がゼロになった📊 LPの競合3社を分析してスプレッドシートに手動でまとめてたのを全自動化した。Sheets APIをClaude Codeで繋いだら、データ取得→整形→シート書き込みまで全自動になった。「手作業→自動化」の達成感は何度やっても慣れない。 #AI副業 #ClaudeCode #自動化",
    "勉強のための調査作業すらAIに任せられる時代になった😳 LP競合分析をClaude Codeに頼んだら3社分のデータ取得→整形→スプレッドシート書き込みまで全部やってくれた。「勉強するための作業」を自動化すると、勉強自体に集中できる時間が増える。 #AI副業 #ClaudeCode #Webマーケティング",
    # ── インスタ×SNS自動化挑戦 ──
    "顔出しなし・バズ狙いなし・全自動で回すインスタを始めることにした📱 AI副業自動化のジャンルで、アカウント設計から始めた。「何を投稿するか」より「誰に届けるか」を先に決める。ゼロから設計するのが一番時間がかかる作業だと気づいた。 #AI副業 #インスタ #自動化",
    "リールは冒頭2秒が全て、と知った。「自分ごと」と感じてもらえるかどうかが勝負。王道は「〇〇で悩んでる人へ」の共感型から入ること。医療職ワーママのAI副業実体験、刺さる人には刺さるはず。コンテンツより「誰が言うか」の方が大事だと実感した。 #AI副業 #インスタ #リール",
    "ジャンルを絞らずに2年・600投稿でフォロワー50人。絞ったら4ヶ月で5万人。プロに直接聞いた話。「やること」より「やらないこと」を決める方が大事だと思い知らされた。インスタに限らず、副業全般に言える教訓。 #AI副業 #インスタ",
    "インスタ投稿も全自動にしたい。テキスト→画像→動画→投稿まで全部つなげる計画中。まずMeta APIの審査を通すのが先で、それが一番の壁😅 でも審査を待ちながら他の部分は全部作り終えた。解禁直後に動ける準備ができてる。 #AI副業 #自動化 #ClaudeCode",
    "インスタで収益化するには「売らない」が正解と知った。価値を提供しまくって、欲しい人だけに案内する。これって自分がLINEボットでやってることと全く同じ設計。プラットフォームが変わっても「先に与える」という本質は変わらない。 #AI副業 #インスタ #マーケティング",
    # ── LINEリッチメニュー・物販フロー ──
    "LINEにリッチメニューを追加した📱 以前はキーワードを覚えないと機能が使えなかった。今は画面下部のボタン6つから一発アクセスできる。Terapeak・メルカリ・利益計算の物販フロー3ステップがボタン1つで開く。使いやすくすると、使う頻度が上がる。 #AI副業 #eBay #物販",
    "仕入れの判断フローを整理した✨ Terapeakで売れ筋確認→メルカリで仕入れ価格確認→利益計算ツールで採算確認。この3ステップを全部LINEのボタンから一発で飛べるようにした。迷わず動けるフローができると、リサーチのスピードが上がる。 #AI副業 #eBay #物販",
    # ── コピーライティング・note ──
    "「AI使ってるのになぜか読まれない」それ、ツールの問題じゃなくてコピーの問題かもしれない。私もずっとズレてた。「伝えたいことを書く」と「読まれる文章を書く」は全然違う。PASONAの型を知ってから、同じ内容でも反応が変わった。学んだことをnoteにまとめた（無料）→ https://note.com/maki_claude_lab/n/n8f70a6d95f32 #AI副業 #副業ワーママ #コピーライティング",
    # ── 秘書ボット改善 ──
    "朝のLINE通知を改良した📅 前は今日・明日の予定が混在してて「これ今日？明日？」と毎朝1秒迷ってた。毎日使うものだからこそその1秒がストレス。今日・明日でセクション分けして、予定なしの日も明示するようにした。細かいUXを磨くほど「自分のために作ってる」感が増す。 #AI副業 #LINE #自動化",
    "毎朝7時の通知が届かなかった→コードを見たらスケジューラーへの登録が1行抜けてただけ💦 ずっと動いてたつもりが最初から動いてなかった。自分で作ったものは自分でデバッグするしかない。でもこういう小さいミスを潰すたびに仕組みへの理解が深まる。怖くなくなってきた。 #AI副業 #個人開発 #ClaudeCode",
    "カレンダーが読み込めてなかった原因は環境変数のJSONに制御文字が混入してたこと🔧 「登録中にエラー」と出たら/check-credsで診断→クリーンJSON再生成→Renderに貼り直しの3ステップで解決した。エラーの原因が見えると怖くない。診断エンドポイントを自分で作っておくと本当に助かる。 #AI副業 #個人開発 #ClaudeCode",
]
