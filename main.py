...
TWEET_STOCK = [
    "習い事チラシ、もう手入力しなくていい🙌 LINEに写真を送るだけでAIが日時を読み取りGoogleカレンダーに自動登録される。 #AI副業 #ワーママ #LINE",
    "締切忘れがゼロになった✨ 申込期限をLINEに送るだけで1週間前・3日前・前日に自動リマインドが届く。 #AI副業 #自動化 #LINE",
    "チラシに複数イベントがあっても全部カレンダーに入るようになった😄 1個しか対応してなかったのを改良。小さい改善ほど使うたびに助かる。 #AI副業 #LINE #自動化",
    "「登録したのに消えた」が起きなくなった🔧 Renderが再起動しても登録待ちデータが消えない仕組みを追加した。 #AI副業 #個人開発 #Claude",
    "毎朝7時に今日の予定がLINEに届く🌅 自分で作ったリマインダー。地味だけど毎日助かってる。 #AI副業 #LINE #自動化",
    "気づいたら20個以上の自動化が動いてた😳 医療職で働きながらLINEボットを作り続けて1ヶ月弱。全部noteにまとめた→ https://note.com/maki_claude_lab/n/n0bf26963cd26 #AI副業 #医療職 #ClaudeCode",
    "ブログ記事の更新が、LINEで「書いて」の一言で完結する✍️ 書く→公開まで全自動。セキスイブログで実現した。 #AI副業 #ブログ自動化 #Claude",
    "薬膳ブログのリライトも自動化。季節に合った記事をAIが選んで、リライトして、公開まで全部やってくれる🌿 #AI副業 #ブログ #自動化",
    "出先でもスマホからeBayリサーチができる📱 LINEに商品名を送るだけで調査が始まる。家のPCに縛られなくなった。 #AI副業 #eBay #物販",
    "Pinterestが解禁された瞬間に動き出せる準備が完了🔧 OAuth認証の実装まで終わらせた。審査待ちの間も止まらない。 #AI副業 #自動化 #Claude",
    "投稿ネタを考えなくていい😌 Xへの毎日自動投稿の仕組みを作ったら本当にラクになった。 #AI副業 #X #自動化",
    "学校のプリント、写真を送るだけで管理できるようになった📄 LINEボットに追加。プリントを失くす心配がなくなった。 #AI副業 #ワーママ #LINE",
    "プログラミングゼロからClaudeで秘書ボットを作るまで全工程まとめた📝 noteで公開中 1,480円→ https://note.com/maki_claude_lab/n/n0bf26963cd26 #AI副業 #note #Claude",
    "忘れっぽい自分向けに、仕組みで強制させてる。A8.netの審査確認が毎週月曜に自動で届く。人間が覚えなくていい設計が正解。 #AI副業 #アフィリエイト #自動化",
    "習慣化って、仕組みで強制させることだと気づいた。月初の振り返りを毎月1日に自動でLINEに届けてる。 #AI副業 #習慣化 #自動化",
    "月0円で24時間稼働を維持してる。RenderにpingエンドポイントをClaude Codeで追加しただけ。無料でも本番運用できる。 #AI副業 #個人開発 #Render",
    "Claudeと一緒にデバッグするの、得意になってきた🔍 タイムアウトエラーをバックグラウンド処理に変えて解決。エラーログを貼るだけで答えが返ってくる。 #AI副業 #個人開発 #Claude",
    "細かいバグこそちゃんと潰す🗓️ 22時開始のイベントが翌0時で終わるとき終了日時が翌日になる処理を追加した。見えないところのクオリティが大事。 #AI副業 #個人開発 #自動化",
    ...
    "アフィリエイトCTAの貼り忘れがゼロになった✨ 薬膳ブログ記事末尾に自動挿入する機能を追加した。 #AI副業 #ブログ #アフィリエイト",
    "自分のAI会社の状況、LINEで「会社」と打つだけで全部見られる👀 売上・記事数・出品数が一覧に。移動中でも確認できる。 #AI副業 #ClaudeCode #自動化",
    "「なんか登録されなかった」が起きなくなった。画像からの複数イベント抽出のJSONパースが不安定だったのを修正した。 #AI副業 #個人開発 #Claude",
    "コードを整理したら次の機能追加がスムーズになった。main.pyをモジュール分割してリファクタリング。読みやすさは開発速度に直結する。 #AI副業 #個人開発 #ClaudeCode",
    "LINEボット1本で、ブログ投稿・カレンダー管理・eBayリサーチ・プリント管理が全部できる。スマホだけで副業が完結しつつある📱 #AI副業 #LINE #自動化",
    "どこに何を頼めばいいか、迷わなくなった😮 「秘書部が司令塔」という概念をAIに導入したから。役割を与えると全然違う。 #AI副業 #ClaudeCode #自動化",
    "子どもが寝た後の1〜2時間でここまで作れるようになった。コードが書けなくても「作りたいもの」が明確なら進める。全工程note→ https://note.com/maki_claude_lab/n/n0bf26963cd26 #AI副業 #ワーママ #副業",
    "自動化の恩恵、記事数が増えるほど大きくなってきた📈 薬膳120記事・セキスイ34記事。量が増えるほど手間が減る仕組みが効いてくる。 #AI副業 #ブログ #アフィリエイト",
    "最初は一番難しかったのに、今では当たり前に使いこなしてる🔑 Google CalendarのOAuth認証をLINEボットに組み込んだ話。慣れって怖い。 #AI副業 #個人開発 #Google",
    "デバッグが怖くなくなった💪 エラーログをClaudeに貼るだけで大体解決する。ゼロからの全記録→ https://note.com/maki_claude_lab/n/n0bf26963cd26 #AI副業 #ClaudeCode #初心者",
    "eBayとメルカリを組み合わせた物販も始めてる。仕入れ→出品の流れをいずれ自動化したい #AI副業 #eBay #物販",
    "毎月忘れてたFamm締切がゼロになった。リマインダーを追加しただけ。小さい自動化ほど日常が楽になる。 #AI副業 #ワーママ #自動化",
    "エラーメッセージひとつで、使い心地が変わる。「登録して」を送ってもデータがないときの返信を改善した。自分が毎日使うものだから細部まで磨く。 #AI副業 #個人開発 #LINE",
    "ChatGPTじゃなくてClaude Codeを使ってる理由：ファイルを直接読み書きできて、コードを実行しながら作れるから。会話型との差がでかい #AI副業 #ClaudeCode #Claude",
    "毎日少しずつ積み上げると、1ヶ月弱でコミット数50以上になった。途中で止まらなかっただけで、こんなに変わる。 #AI副業 #ClaudeCode #副業",
    "LINE秘書ボットを作って一番変わったこと：「あれ、今日何の予定あったっけ」がゼロになった。地味だけど毎日助かってる #AI副業 #LINE #ワーママ",
    "アイキャッチ画像も自動になった🖼️ セキスイブログをPexels APIと連携させた。記事を書いたら画像選びも全部終わる。 #AI副業 #ブログ自動化 #Claude",
    "最初は何が何かわからなかった環境変数、今は10個以上を全部把握できてる。理解は突然やってくる。 #AI副業 #個人開発 #Render",
    "週の動きが自然に決まってきた。月曜A8確認・火曜薬膳ブログ・木曜セキスイブログ・土曜eBayチェックを全部自動通知にした。 #AI副業 #副業 #習慣化",
    # ── まるちゃんワールド（ゲーム系） ──
    "息子と一緒に遊べるタイピングゲームを、Claude Codeで作った🎮 プログラミングゼロで完成。 #AI副業 #ClaudeCode #ゲーム開発",
    "プログラミングゼロでゲームシリーズを作り始めた。タイピング・アクションをHTMLファイル1枚ずつ。コードは全部Claudeが書いてくれた。「まるちゃんワールド」 #AI副業 #ClaudeCode",
    "AIで作ったゲームをGitHub Pagesで無料公開した📡 URLを共有するだけでどこからでも遊べる。サーバー代0円。 #AI副業 #個人開発 #ClaudeCode",
    "子どものタイピング練習用にゲームを作ったら自分もハマった😂 かんたん・ふつう・むずかしい・1文字モードの4段階。BGMも効果音も全部AIが生成 #AI副業 #ワーママ",
    "むずかしいは本当にむずかしい笑🎵 まるちゃんワールドに音ゲーを追加した。F・G・H・Jキーでノーツをたたく3ステージ。コードは全部Claude製。 #AI副業 #ClaudeCode #ゲーム開発",
    ...
    # ── eBay API連携 ──
    "自分の出品120品がリストで見られるようになった📦 eBayのAPIをClaude Codeで連携させた。プログラミングゼロでもAPIって繋げる。 #AI副業 #eBay #物販",
    "手動でeBayのマイページ確認しなくていい🙌 売上・ウォッチャー数・出品総額が一瞬でわかるようにAPIで自動取得した。 #AI副業 #eBay #自動化",
    "eBayの出品上限（金額制限）の存在を知らなかった😳 $7,000/月の壁。Claudeが一緒にSeller Hubを解読してくれて助かった。5月1日にリセットされるから待機中 #AI副業 #eBay #物販",
    "英語苦手でも全然平気。eBayのサポートチャット文面、全部Claudeに作ってもらった。英語の壁はAIで消えた。 #AI副業 #eBay #物販",
    "eBayの出品タイトルを51件APIで一括変更した✨ 「Kumano Fude」「Japan Unused New」などの検索キーワードを全部追加。手作業だったら半日かかるのが数分で完了 #AI副業 #eBay #自動化",
    "eBay Trading APIのReviseFixedPriceItemを使えば、出品中のタイトルをコードで一括変更できる📝 CTR改善のためにキーワード追加を全商品に適用。プログラミングゼロでも仕組みさえ作れば毎回ラク #AI副業 #eBay #物販",
    ...
    "ブログのアイキャッチにタイトルが自動合成されるようになった🖼️ Instagram用にリサイズまでPythonで全自動。思ったより簡単だった。 #AI副業 #Python #自動化",
    # ── 音声文字起こし ──
    ...
    "途中でネット切断されて13/18チャンクで止まって絶望した😇 でも「前回の続きから再開する機能」をClaudeにその場で追加してもらって、次回起動したら14チャンク目から自動スタート。ゼロからやり直しにならない仕組みって大事 #AI副業 #ClaudeCode #自動化",
    "3時間の会議録音（176分）→自動で18分割→文字起こし→チャプターごと要約→議事録をデスクトップに保存。コスト0円、やることはファイル選んで待つだけ🎤 #AI副業 #自動化 #時短",
    "InstagramにビルのPexels写真が自動投稿されてて「いまいちすぎる」と気づいた😂 日本語タイトル→Claudeが英語キーワードに変換→住宅系写真に改善。自動化は作って終わりじゃなくてこういう細かい改善の積み重ね #AI副業 #自動化 #ClaudeCode",
    # ── 薬膳Instagram・SNS自動化 ──
    "薬膳ブログのアイキャッチ画像を自動化した🌿 日本語タイトルをAIが英語キーワードに変換→Pexelsで完成料理写真を取得→WPに自動設定。食材の並びじゃなくて「食べたい！」写真になった #AI副業 #ブログ自動化 #薬膳",
    "記事を公開したらInstagram用スライドが自動生成される📸 1枚目:料理写真 2枚目:食材 3枚目:効能まとめ。あとはカルーセル投稿するだけ。 #AI副業 #Instagram #自動化",
    "医師ママが実践する薬膳レシピのInstagramアカウント（@foodmakehealth）を開設した🌿 医療職という肩書きを前面に出すとコンセプトが一気に明確になった #AI副業 #薬膳 #Instagram",
    "Amazonアフィリエイトの貼り忘れがゼロになった📚 薬膳記事の内容を見て「子ども向け→こども薬膳」「スープ系→スープジャー弁当」と自動判定して挿入する仕組みを作った。 #AI副業 #アフィリエイト #自動化",
    "特定の薬膳記事だけリライトできるようになった🔄 記事URLをLINEに貼るだけ。2ステップで完結する。 #AI副業 #ブログ自動化 #LINE",
    "薬膳記事のテーマ選定を完全自動化した🌱 4月なら「花粉症・PMS・春の倦怠感」、7月なら「夏バテ・熱中症」と季節×症状で自動決定。子ども向けも月に数回混ぜてバランス取ってくれる #AI副業 #薬膳 #自動化",
    "薬膳ブログのInstagram用カルーセル画像、2枚目・3枚目がずっと届かなかった原因がフォントファイルのバイナリ破損だった😅 .gitattributesで解決。地味なバグほど原因特定に時間かかる #AI副業 #個人開発 #ClaudeCode",
    "薬膳ブログのテーマ自動選定、最初はPMSばかり選ばれてた😂 18カテゴリのローテーションリストを作って直近15記事と照合→未使用カテゴリを選ぶ仕組みにしたら均等になった #AI副業 #ブログ自動化 #薬膳",
    # ── eBayリサーチAI進化 ──
    "eBayリサーチ、スマホのLINEだけで完結するようになった📦 「ebay 風呂敷」と送るだけで10個のキーワードを並列検索してくれる。 #AI副業 #eBay #物販",
    "需要ある穴場商品を見つける精度が上がった👀 eBayリサーチに「ウォッチャー数」を追加。競合少×価格高×ウォッチ多＝穴場の判定ロジック。 #AI副業 #eBay #物販",
    "AIが出した候補を自分の目で最終確認する、この一手間が大事💡 eBayリサーチの結果に「次のステップ」を追加した。流れ：検索→Sold Listingsで絞る→30日の売れ数確認。 #AI副業 #eBay #物販",
    "eBayリサーチを並列検索に変えたら速くなった⚡ 今まで1個ずつ順番に検索してたのを同時に全部検索する方式に。Team Agent的な考え方、物販リサーチにも使える #AI副業 #eBay #ClaudeCode",
    # ── Webマーケティング・Sheets API ──
    "コピペ作業がゼロになった📊 競合分析データをスプレッドシートに自動書き込み。Sheets APIをClaude Codeで10分で繋いだ。 #AI副業 #ClaudeCode #自動化",
    "勉強のための作業すらAIに任せられる時代になった😳 LP競合分析をClaude Codeに頼んだら3社分のデータ取得→整形→スプレッドシート書き込みまで全自動だった。 #AI副業 #ClaudeCode #Webマーケティング",
    # ── インスタ×SNS自動化挑戦 ──
    "顔出しなし・バズ狙いなし・全自動で回す。そんなインスタを始めることにした📱 AI副業自動化のジャンルで。アカウント設計中。 #AI副業 #インスタ #自動化",
    "リールは冒頭2秒が全て、と知った。「自分ごと」と思われるかどうかが勝負。王道は「〇〇で悩んでる人へ」の共感型。医療職ママのAI副業話、刺さる人には刺さるはず。 #AI副業 #インスタ #リール",
