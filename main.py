...
TWEET_STOCK = [
    ...
    "【公開】プログラミングゼロからLINE秘書ボットを作るまでの全工程をnoteにまとめた。何から始めたか・どうClaudeに頼んだか・失敗してどう直したか、全部書いた。1,480円。「自分もできるかも」と思ってもらえたら嬉しい→ https://note.com/maki_claude_lab/n/n0bf26963cd26 #AI副業 #note #Claude",
...
QUOTE_TWEET_TEMPLATES = [
    ...
    # note・収益化系への引用
    "私も1,480円のnoteを公開してます。まず体験があって初めて書けるものがある。LINEボット・ブログ自動化・eBayを全部作ってから初めて書けた記事だった。→ https://note.com/maki_claude_lab/n/n0bf26963cd26 #AI副業 #note",
