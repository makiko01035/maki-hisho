...
QUOTE_TWEET_TEMPLATES = [
    ...
    "楽天アフィは物販より『サービス系CPA』が高単価だと気づいた。楽天カードの成約報酬は商品アフィの何十倍にもなる。旅行アカウントからカードに誘導するのは自然な流れ。週2回、自動で誘導ツイートが出るよう設定した。 #AI副業 #楽天アフィ #収益化",
    "楽天アフィのジャンルは『1〜2ヶ月前シフト』で組むのが正解だった。8月のお盆需要のために6月から帰省グッズを投稿する。季節のタイムラグを読んで投稿ネタをJSON管理したら、年間の戦略が1ファイルで完結した。 #AI副業 #楽天アフィ #自動化",
    "楽天ROOMは通常アフィより稼ぎやすいと知ってROOMに切り替えた。普通のアフィリンクより『ROOMランクボーナス』が乗るので同じ商品でも収益が変わる。商品登録は手動だけど、URLさえ設定すればあとは全自動で投稿される。 #AI副業 #楽天アフィ #楽天ROOM",
    "Threadsのコードも書き終わった。あとはトークンをRenderに設定するだけで、朝7:30・夜20:00・楽天カード誘導週2・ROOM誘導週1が全自動で動き出す。仕組みを作ってしまえば、プラットフォームが増えても追加コストがほぼゼロになる。 #AI副業 #自動化 #Threads",
